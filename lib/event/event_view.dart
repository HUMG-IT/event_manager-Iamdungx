...
class _EventViewState extends State<EventView> {
  ...
  // Tạo CalendarController để điều khiển
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton<CalendarView>(
            ...
            itemBuilder: (context) => CalendarView.values.map(
              (view) => PopupMenuItem(
                value: view,
                child: ListTile(
      ...
      body: SfCalendar(
        ...
        // Nhấn giữ để thêm sự kiện
        onLongPress: (details) {
          // Không có sự kiện nào trong cell
          if (details.targetElement == CalendarElement.calendarCell) {
            // Tạo một sự kiện tại thời gian trong lịch
